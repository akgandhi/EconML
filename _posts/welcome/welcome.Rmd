...
knitr::include_graphics("23-tree/ex1-tree.png")
knitr::include_graphics("23-tree/ex1-regions.png")
```
...
```{r, out.width = '75%'}
knitr::include_graphics("23-tree/ex1-notpos.png")
```
...
![](23-tree/split1.pdf){width=50% height=400}![](23-tree/split2.pdf){width=50% height=400}
...
<center>
![](23-tree/stop.pdf){width=50% height=400}
</center>
...
- This gives us a decreasing sequence of trees $$T_{0} \prec T_{1} \dots \prec t_{root}$$ all the way down to the root node $t_{root}$, as well as an increasing sequence of $\alpha$ values $0 < \alpha_{1} < \alpha_{2} < \dots $
...
```{r}
knitr::include_graphics("23-tree/spamcv.png")
```
...
```{r}
knitr::include_graphics("23-tree/spamtree.png")
```
